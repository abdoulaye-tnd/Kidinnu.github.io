...
где велчиина $$c$$ представляет собой скорость распространения звука в материале стержня:

$$
  c^2 = \frac{E \cdot A}{\mu}
$$

$$E$$ -- модуль упругости материала, $$A$$ -- площадь поперечного сечения.

Сложные малые колебания системы, которая представляет собой систему с бесконечным числом степеней свободы, представляется в виде суммы гармонических колебаний   

$$
y(x,t) = d(x) \sin (p \cdot t + \alpha)
$$

где $$d(x)$$ -- форма главного колебания  -- амлитудное значение деформации, как функция положения точки на стержне.
...
Постоянные $$M_i$$, $$N_i$$ определяются из начальных условий -- начальной деформации стержня, заданной функцией положения точки на стержне

$$
y(x,0) = f(x)
$$

и начальными скоростями точек стержня
